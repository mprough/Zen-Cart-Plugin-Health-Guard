...
version_root="$root/files/zc_plugins/PluginHealthGuard/v1.0.2"
...
grep -Fq "'pluginVersion' => 'v1.0.2'" "$version_root/manifest.php"
grep -Fq "public string \$version = '1.0.2'" "$version_root/Installer/ScriptedInstaller.php"
grep -Fq "'PLUGIN_HEALTH_GUARD_VERSION', '1.0.2'" "$version_root/Installer/ScriptedInstaller.php"
