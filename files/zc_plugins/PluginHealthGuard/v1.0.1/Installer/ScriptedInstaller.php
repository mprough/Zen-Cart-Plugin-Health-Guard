...
class ScriptedInstaller extends ScriptedInstallBase
{
    ...
    protected function executeInstall(): bool
    {
        $this->executeInstallerSql(
            "INSERT IGNORE INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function) VALUES ('Installed version', 'PLUGIN_HEALTH_GUARD_VERSION', '1.0.1', 'Installed Plugin Health Guard version.', 0, 0, 'zen_cfg_select_option(array(\\'1.0.1\\'),')"
        );
        $this->executeInstallerSql(
            "UPDATE " . TABLE_CONFIGURATION . " SET configuration_value = '1.0.1', set_function = 'zen_cfg_select_option(array(\\'1.0.1\\'),' WHERE configuration_key = 'PLUGIN_HEALTH_GUARD_VERSION'"
        );
